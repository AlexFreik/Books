...
\makeevenhead{chap}{\currentname}{}{\hyperref[TOC]{Оглавление}}   %
\makeoddhead{chap}{\hyperref[TOC]{Оглавление}}{}{\currentname}    %
...
\newpage
\begin{tikzpicture}
\draw[black,thick] (0,0) -- (\textwidth,0);
\draw[black,thick] (0,0.1) -- (\textwidth,0.1);
\end{tikzpicture}
\subsection*{\Large #1}
